...
let slog = require('./single-line-log.js').stdout;
...
class ProgressBar {
    ...
    render = function (opts) {
        ...
        // 拼接最终文本
        let cmdText = this.description + ': ' + (100 * percent).toFixed(2) + '% ' + cell + empty + ` ${opts.completed}/${opts.total} (已运行：${formatTime((Date.now() - this.start_time) / 1000)})`;
