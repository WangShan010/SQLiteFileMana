...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "path", "./access_token.js", "../../../com/configTool.js", "../Util/readFromDB.js", "../Util/readFromNet.js", "../Util/initDB.js", "../Util/saveToDB.js", "../Util/saveToFile.js", "../Util/readFromDisk.js"], factory);
    }
    ...
    const readFromDisk_js_1 = __importDefault(require("../Util/readFromDisk.js"));
    let Loading = true;
    ...
    let MapboxTile = {
        ...
        async getSatelliteFileBuffer(z, x, y) {
            ...
            let url = `${satelliteUrl}\\${z}\\${x}\\${y}?access_token=` + access_token_js_1.default;
            ...
            [err, buffer, dataSource] = await (0, readFromDisk_js_1.default)({ fileSavePath, err, buffer, dataSource });
        ...
        async getTerrainRGBFileBuffer(z, x, y) {
            ...
            let url = `${terrainRGBUrl}\\${z}\\${x}\\${y}@2x.pngraw?access_token=` + access_token_js_1.default;
