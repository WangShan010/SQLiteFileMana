...
import Tile from './TileImpl/Tile.js';
import TileSet from './TileSet.js';
import FSTool from '../FSTool/index.js';
...
class CheckLackTile {
    ...
    async scanTileList(scanZoom = -1) {
        ...
        const filePathList = await FSTool.getFilePathList(scanPath);
    ...
    async findLackTile(allTileList: Tile[], scanZoom = -1) {
