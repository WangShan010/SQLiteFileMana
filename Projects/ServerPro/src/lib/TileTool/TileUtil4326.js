...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "../../lib/TileTool/TileImpl/TileBox.js", "../awaitWrap.js"], factory);
    }
    ...
    const awaitWrap_js_1 = __importDefault(require("../awaitWrap.js"));
    ...
    class TileUtil4326 extends TileUtil {
        ...
        tileXYZToRectangle(x, y, zoom) {
            ...
            let tileBox = new TileBox_js_1.default();
        ...
        async loadTile(tileRootPath, minZoom, maxZoom, geoJson, log = false) {
            ...
            for (let i = 0; i < tileList.length; i++) {
                let tile = tileList[i];
                map.set(i, (0, awaitWrap_js_1.default)(axios.get(`http://localhost:3000/cacheServer/assets.cesium.com/1/${tile.zoom}/${tile.x}/${tile.y}.terrain`).then(() => {
                    map.delete(i);
                    if (i % 100 === 0) {
    ...
    return new TileUtil4326();
});
//# sourceMappingURL=TileUtil4326.js.map