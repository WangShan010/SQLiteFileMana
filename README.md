...
将硬盘中【数千万零碎文件】存储到 SQLite 的 BLOB 类型中，并能对外发布 HTTP 服务供访问。主要用于 WebGIS 运维，是一款易用的 GIS 资源存储分发程序，**服务端源码完全开源**，个人与企业可 100% 免费使用，但需保留原作者署名。
...
> 前言：我是GIS行业的一名普通程序🐶，喜欢追逐新鲜的技术，渴望做一些好玩、有用的东西。这项目是我程序员生涯中开源的第一个作品，虽然技术能力有限，但很高兴有这么多人能 Start 我的项目，非常欢迎有时间有精力的小伙伴能与我一起构建这个项目。
...
> ⑥ 软件是免费使用吗？
>
> 答：本项目于2021年8月发起，作者耗费大量业余的时间、精力独立开发。软件免费使用，包含两个独立的程序：服务端程序、操作面板程序，如下：
>
> - Server-win-x64.exe
>
...
> - WinUI-win32-x64.exe
>
>   一个用于管理资源库的操作面板，基于 Election 开发，可直接弹起系统自带的 【选择文件】、【选中文件夹】对话框，更便于用户操作，需要在本机上使用。后续会继续进行新功能的开发、修复BUG，计划每 2 个月发布一版免费使用的发行版。
>
>   
...
我们在代码层面对 SQLite【数据建库】操作做了非常多的优化。包括：SQL 语句聚合、开启事务、多线程优化等。单线程速度为【1千个文件 / 秒】，多线程【2万个文件 / 秒】的极致优化。
...
| Server   | 131,584 个 .terrain 地形文件；开启5线程，建库         | 35s  |
...
| 测试平台 | 测试项                                                       | 结果 |
| -------- | ------------------------------------------------------------ | ---- |
| Server   | 全球 0-12 级MapBox 卫星瓦片，83.2 GB共计 2236 万零碎文件的资源库，随机读出某个瓦片 | 9ms  |
