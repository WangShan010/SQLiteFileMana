...
const sqlite3Promise = require('../../../com/DBMana/DBTool/sqlite3-promise.js');
const FSTool = require('../../FSTool/index.js');

async function openDB(dbName) {
    const cacheSql = FSTool.readFileSync(path.join(__dirname, 'cache.sql'), 'utf8');
    const dbPath = configTool.appBasePath + '/Cache/' + dbName + '.db';
